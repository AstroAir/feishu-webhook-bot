...
# Simple chat
response = await bot.ai_agent.chat("user123", "What is Python?")
print(response)

# Continue conversation (maintains context)
response = await bot.ai_agent.chat("user123", "Give me an example")
print(response)
```

### Use Chat Controller

For multi-platform chat with commands:

```python
from feishu_webhook_bot.chat import create_chat_controller, ChatConfig

# Create controller with built-in commands
...
# Built-in commands: /help, /reset, /model, /status, /clear
```
...
4. **Enable AI features**: Configure AI agent for intelligent responses

### Develop Custom Plugins

1. Read the [Plugin Development Guide](../guides/plugin-guide.md)
...
5. **Multi-platform support**: Use [Chat Controller](../guides/chat-controller-guide.md) for Feishu and QQ
6. **AI Commands**: Built-in [command system](../ai/commands.md) (/help, /reset, /model)
7. **MCP Integration**: Connect to [MCP servers](../ai/mcp-integration.md) for extended AI capabilities
8. **Persistent Conversations**: Store chat history with [Conversation Store](../ai/conversation-store.md)
...
- Explore the [Plugin Development Guide](../guides/plugin-guide.md)
- Review the [API Documentation](../reference/api.md)
- Check out [Contributing Guidelines](../resources/contributing.md)
