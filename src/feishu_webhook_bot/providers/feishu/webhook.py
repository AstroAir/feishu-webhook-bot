"""Feishu webhook provider implementation.

This module provides the FeishuProvider class for sending messages
...
from .signature import generate_feishu_sign
...
class FeishuProvider(BaseProvider, HTTPProviderMixin):
    ...
    def _send_request(self, url: str, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.config.secret:
            sign, timestamp = generate_feishu_sign(self.config.secret)
    ...
    def _make_http_request(self, url: str, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        validator = create_response_validator("code", 0, "msg")
    ...
    def _generate_sign(self, timestamp: int) -> str:
        ...
        sign, _ = generate_feishu_sign(self.config.secret, timestamp)
        return sign
