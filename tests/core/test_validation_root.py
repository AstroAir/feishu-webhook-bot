...
class TestJSONSchemaGeneration:
    ...
    def test_schema_has_required_fields(self):
        ...
        # Webhooks should have specific structure
        webhooks_schema = schema["properties"]["webhooks"]
        assert "type" in webhooks_schema
        assert webhooks_schema["type"] == "array"
...
class TestConfigDictValidation:
    ...
    def test_validate_valid_dict(self):
        ...
        config_dict = {"webhooks": [{"name": "default", "url": "https://example.com/webhook"}]}
            ...
            "tasks": [
                {
                    ...
                    "actions": [{"type": "send_message", "webhook": "default", "message": "test"}],
                }
            ],
        }
    ...
    def test_validate_invalid_dict(self):
        ...
        config_dict = {"webhooks": [{"name": "default"}]}  # Missing required 'url'
    ...
    def test_validate_empty_dict(self):
        ...
        # An empty dict is actually valid - all fields are optional
        # But it would fail when trying to create a BotConfig since webhooks is required
        assert is_valid is True
        assert len(errors) == 0
...
class TestConfigCompleteness:
    ...
    def test_check_minimal_config_completeness(self, fixtures_dir):
        ...
        # Minimal config should have moderate completeness (only webhooks defined)
        assert info["completeness_percentage"] < 70
